...
To get a list of all valid values for platform-name and platform-family, run `inspec schema platforms`, which will dump the current supported list in JSON format.
