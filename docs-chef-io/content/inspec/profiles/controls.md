...
## Use controls from an included profile

Once a dependent profile is [defined in the `inspec.yml` file](/inspec/profiles/depends/), you can use controls from those profiles.
...
![Controls from a dependent profile included using include_controls command.](/images/inspec/include_controls.png)
...
![Use skip_control function to skip specified controls.](/images/inspec/include_controls_with_skip.png)
