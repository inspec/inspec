...
When you run Chef InSpec 6 or later for the first time, using a command such as `inspec exec`, you will be prompted for a Chef License Key. If you do not have one, you will have the opportunity to generate one.
