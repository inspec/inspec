...
class FirewallD < Inspec::resource(1)
  ...
  def has_service_enabled_in_zone?(query_zone=default_zone, query_service)
  ...
  def has_port_enabled_in_zone?(query_zone=default_zone, query_port)
  ...
  def has_rule_enabled?(query_zone=default_zone, rule)
