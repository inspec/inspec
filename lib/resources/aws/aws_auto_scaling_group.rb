...
class AwsAutoScalingGroup < Inspec.resource(1)
  ...
  def fetch_from_api
    aws_response = BackendFactory.create(inspec_runner).get_autoscaling_group_attributes(autoscaling_group_names: [@name])
  ...
  class Backend
    class AwsClientApi < AwsBackendBase
      ...
      def get_autoscaling_group_attributes(criteria)
