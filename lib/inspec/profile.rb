  ...
  class Profile
    ...
    def info_from_parse(include_tests: false)
      ...
      @source_reader.tests.each do |control_filename, control_file_source|
        ...
        input_collector = Inspec::Utils::Profile::AstHelper::InputCollectorOutsideControlBlock.new(@info_from_parse)
        ctl_id_collector = Inspec::Utils::Profile::AstHelper::ControlIDCollector.new(@info_from_parse, source_location_ref,
    ...
    def update_groups_from(control_filename, src)
      ...
      source_location_ref = @source_reader.target.abs_path(control_filename)
      Inspec::Utils::Profile::AstHelper::TitleCollector.new(group_data)
