...
module Inspec
  class Rule
    ...
    def initialize(id, profile_id, opts, &block)
      ...
      evaluate_control_block
    end

    def evaluate_control_block
      # evaluate the given definition
      # Some resource code is executed outside of describe blocks
      #   calling before and after instance eval on the CustomBase
      #   rspec formatter will all mapping the control id with
      #   messages that are generated by resources.
      Inspec::Formatters::CustomBase.before_instance_eval(@__rule_id)
      instance_eval(&@__block)
      Inspec::Formatters::CustomBase.after_instance_eval(@__rule_id)
      ...
      location = @__block.source_location.compact.join(":")
