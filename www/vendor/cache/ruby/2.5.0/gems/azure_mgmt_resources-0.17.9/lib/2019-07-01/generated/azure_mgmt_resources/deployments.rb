  ...
  class Deployments
    ...
    def create_or_update_at_scope_async(scope, deployment_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Resources::Mgmt::V2019_07_01::Models::DeploymentExtended.mapper()
    ...
    def validate_at_scope_async(scope, deployment_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Resources::Mgmt::V2019_07_01::Models::Deployment.mapper()
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Resources::Mgmt::V2019_07_01::Models::DeploymentValidateResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def export_template_at_scope_async(scope, deployment_name, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Resources::Mgmt::V2019_07_01::Models::DeploymentExportResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def list_at_scope_async(scope, filter:nil, top:nil, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Resources::Mgmt::V2019_07_01::Models::DeploymentListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def what_if_at_subscription_scope_async(deployment_name, parameters, custom_headers:nil)
      ...
      promise = promise.then do |response|
        # Defining deserialization method.
        deserialize_method = lambda do |parsed_response|
          result_mapper = Azure::Resources::Mgmt::V2019_07_01::Models::WhatIfOperationResult.mapper()
          parsed_response = @client.deserialize(result_mapper, parsed_response)
        end
    ...
    def calculate_template_hash_async(template, custom_headers:nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::Resources::Mgmt::V2019_07_01::Models::TemplateHashResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    def begin_what_if_at_subscription_scope_async(deployment_name, parameters, custom_headers:nil)
      ...
      # Serialize Request
      request_mapper = Azure::Resources::Mgmt::V2019_07_01::Models::DeploymentWhatIf.mapper()
      request_content = @client.serialize(request_mapper,  parameters)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil
