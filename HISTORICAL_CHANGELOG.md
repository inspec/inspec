...
Beginning with v1.20.0, InSpec moved to a different ChangeLog Generator configuration
that is based on the labels of pull requests. To avoid having to go back through
all historical PRs and relabel them, the v1.20.0 release and earlier are listed in
