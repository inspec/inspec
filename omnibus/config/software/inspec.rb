...
build do
  ...
  copy "#{project_dir}/test/inspec-test-binstub", "#{install_dir}/embedded/bin/inspec"
  ...
  block do
    ...
    mkdir "#{inspec_gem_path}/bin/"
    copy "#{project_dir}/test/inspec-test-binstub", "#{inspec_gem_path}/bin/inspec"
  end
