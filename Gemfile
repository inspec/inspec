...
gem "train", git: "https://github.com/inspec/train.git", branch: "CHEF-27860-update-ffi-version"
gem "train-core", git: "https://github.com/inspec/train.git", branch: "CHEF-27860-update-ffi-version"
