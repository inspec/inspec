...
curl https://chefdownload-commericial/install.sh?license_id=<YOUR LICENSE ID> | sudo bash -s -- -P inspec

# Windows
. { iwr -useb https://chefdownload-commericial/install.ps1?license_id=<YOUR LICENSE ID> } | iex; install -project inspec
```
