...
resource "aws_iam_role" "role_for_config_delivery_channel" {
  name = "role_for_config_delivery_channel"
...
resource "aws_iam_role_policy" "policy_for_delivery_channel" {
  ...
  role = "${aws_iam_role.role_for_config_delivery_channel.id}"
