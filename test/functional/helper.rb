...
module FunctionalHelper
  ...
  def inspec(commandline, prefix = nil)
    ...
    commandline += " --allow-unsigned " if (commandline =~ /\bexec\b/ || commandline =~ /\bexport\b/ || commandline =~ /\barchive\b/ || commandline =~ /\bcheck\b/ || commandline =~ /\bjson\b/) && !(commandline =~ /\ballow-unsigned\b/)
  ...
  def run_inspec_process(command_line, opts = {})
    ...
    command_line += " --allow-unsigned #{opts[:allow_unsigned]}" if command_line =~ /\bexec\b/ || command_line =~ /\bexport\b/ || command_line =~ /\barchive\b/ || command_line =~ /\bcheck\b/ || command_line =~ /\bjson\b/
