class MockLoader
  ...
  def backend
    ...
    mock_cmds = {
      ...
      "cat /root/.ssh/authorized_keys" => cmd.call("authorized-keys-mock"),
      "cat /Users/chartmann/.ssh/authorized_keys" => cmd.call("authorized-keys-mock"),
      "cat /home/fzipi/.ssh/authorized_keys" => cmd.call("authorized-keys-mock"),
      "cat /jfolmer/.ssh/authorized_keys" => cmd.call("authorized-keys-mock"),
      "cat ~root/.ssh/authorized_keys" => cmd.call("authorized-keys-mock"),
