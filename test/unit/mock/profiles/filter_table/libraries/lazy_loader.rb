class LazyLoader < Inspec.resource(1)
  ...
  filter_table_generator.add(:lazy_1s, field: :lazy_1, lazy: ->(r,c,t) { :lazy_1_loaded } )
  filter_table_generator.add(:lazy_2s, field: :lazy_2, lazy: ->(r,c,t) { :lazy_2_loaded } )
  filter_table_generator.add(:lazy_3s, field: :lazy_3, lazy: ->(r,c,t) { t.resource.lazy_3_call_count += 1 } )
